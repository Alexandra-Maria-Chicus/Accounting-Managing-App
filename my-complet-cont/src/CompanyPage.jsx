...
function CompanyPage({ firm, allEntries, currentUser, onClose, onAddObservation, onToggleObservation, onDeleteObservation }) {
  ...
  const handleAddObs = async () => {
    ...
    const obs = await onAddObservation(firm.id, obsText);
    setLastAddedId(obs.id);
    setObsText('');
    setObsError('');
  };
        ...
        <Row>
          ...
          <Col md={isClient ? 12 : 6}>
            ...
            <p className="fw-medium">
              {currentMonthEntry
                ? new Date(currentMonthEntry.dateBrought + 'T00:00:00').toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' })
                  ...
                  <div key={record.id} className="mb-4 position-relative">
                    ...
                    <div className="d-flex justify-content-between">
                      ...
                      <span className="small text-muted">
                        {new Date(record.dateBrought + 'T00:00:00').toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' })}
                      </span>
                    </div>
                  ...
                  <div key={record.id} className="mb-4 position-relative">
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="d-flex align-items-center gap-2">
                        <span className="small text-muted">
                          Brought in: {new Date(record.dateBrought + 'T00:00:00').toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' })}
                        </span>
