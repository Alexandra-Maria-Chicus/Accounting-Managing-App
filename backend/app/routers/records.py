...
def list_records(
    ...
    return record_service.get_all(page, page_size, month, year)
...
def delete_record(record_id: int):
    if not record_service.delete(record_id):
        raise HTTPException(status_code=404, detail="Record not found")
